  ...
  async run() {
    ...
    const items = [
      ...
      },
      {
        ...
        description: 'When the wearer kills 2 or more enemies with a single attack, the attack doesnt spend all of the wearers MP	.',
        itemSlot: 7, // Boots
        act: 2,
        createdAt: new Date()
      },
      ...
      {
        name: 'Daemon Tool',
        description: 'When weaer inflict warp dmg, target suffers burning (3) burning effects inflicted by the wearer scale with veil degregation.',
        itemSlot: 3, // Necklace
        act: 2,
        createdAt: new Date()
      },
