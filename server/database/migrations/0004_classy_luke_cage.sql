...
INSERT INTO `__new_companions`("id", "name", "smallPortait", "origin_id", "homeworld_id", "act_id", "starter_level", "created_at") SELECT "id", "name", "smallPortait", "origin_id", "homeworld_id", "act_id", "starter_level", "created_at" FROM `companions`;--> statement-breakpoint
